$(document).ready(function() {
    ...
    // $("#questions").text("hi there");
    var questions = [
        'I always have a goal in mind.',
        'I prefer to netflix and chill over going out.',
        'I am more functional at nights rather than days.',
        'I am creative.',
        'I prefer to hang out around outgoing people.',
        'I am very critical of myself.',
        'I prefer to work for myself than working for a company.',
        'I always fall asleep halfway through a movie',
        'Dogs over cats.',
